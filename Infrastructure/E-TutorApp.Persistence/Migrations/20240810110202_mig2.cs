        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstructorDetailId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StudentDetailId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseDetailStudent", x => new { x.EnrolledCoursesOfStudentId, x.StudentsId });
                    table.ForeignKey(
                        name: "FK_CourseDetailStudent_Courses_EnrolledCoursesOfStudentId",
                        column: x => x.EnrolledCoursesOfStudentId,
                        principalTable: "Courses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CourseDetailStudent_DetailStudent_StudentsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SectureId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseDetailStudent_StudentsId",
                table: "CourseDetailStudent",
                column: "StudentsId");
